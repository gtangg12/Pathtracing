...
template <typename T>
bool xcmp(const Vec3<T> &u, const Vec3<T> &v) {
	return u.x < v.x;
}

template <typename T>
bool ycmp(const Vec3<T> &u, const Vec3<T> &v) {
	return u.y < v.y;
}

template <typename T>
bool zcmp(const Vec3<T> &u, const Vec3<T> &v) {
	return u.z < v.z;
}
...
template<typename T>
void print(const Vec3<T> &u) {
	cout << u.x << ' ' << u.y << ' ' << u.z << ' ';
}

template<typename T>
void println(const Vec3<T> &u) {
	cout << u.x << ' ' << u.y << ' ' << u.z << '\n';
}
...
template<typename T>
Vec3<T> operator*(const T k, const Vec3<T> &u) {
...
template<typename T>
Vec3<T> operator/(const Vec3<T> &u, const T k) {
 ...
 */
template<typename T>
double len(const Vec3<T> &u) {
	return sqrt(u.x*u.x + u.y*u.y + u.z*u.z);
}

template<typename T>
Vec3<T> unit(const Vec3<T> &u) {
	double m = len(u);
 ...
 */
template<typename T>
Vec3<T> reflect(const Vec3<T> &u, const Vec3<T> &n) {
	return u - 2*dot(u, n)*n;
}

// UNTESTED
template<typename T>
Vec3<T> refract(const Vec3<T> &u, const Vec3<T> &n, const double r) {
	double c1 = dot(u, n);
	double e = 1.0/r;
